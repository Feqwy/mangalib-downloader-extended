...
└── Series_Name/
    ...
    └── Volume 01/
        ├── Chapter 001/
        │   ├── 001.png
        │   ├── 002.png            # Режим без CBZ и метаданных
        │   ├── 003.png
        │   └── ...
```
...
- Универсальный API‑клиент с кэшированием и устойчивыми retry‑механизмами
- Поддержка дробных и строковых номеров глав через индексы
...
- Поддержка дополнительных глав `extra_chapters`
